...
def default_menu():
    try:
        ...
        choose_text = '''(1) - Rechercher avec un Email. GMAIL ETC      /  (5) - Rechercher via un Password. MOT DE PASSE MDP
(2) - Rechercher avec un Username Pseudo    /  (6) - Rechercher avec un mot de passe Hash.
(3) - Rechercher via une Adresse Ip.IPV  /  (7) - Rechercher avec ComboLST.
(4) - Whois une Adresse Ip. IPV           /  (8) - Rechercher avec Prenom & Nom. dx
               (exit)pour leave le tool ! '''
